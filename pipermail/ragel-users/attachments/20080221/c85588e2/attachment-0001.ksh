...
# Ragel fsm
    ...
    charStringWithSpace = ('_' | alnum)    ( ('_' | alnum | [ \-])* ('_' | alnum) )?
        >to{stringval.clear(); stringval = stringval + fc;}
        ${stringval = stringval + fc; }
    ;
    
    charStringWithSpace2 = ('_' | alnum)    ( ('_' | alnum | [ \-])* ('_' | alnum) )?
...
inline int GetAtomID(OBAtom *atomPtr)
{
        NXMoleculeData *atomIDData = 
            static_cast<NXMoleculeData*>(atomPtr->GetData(NXMoleculeDataType));
